...
public class ContactTest {
	...
	public void testUUID() {
		assertEquals("177ca340-ffa2-11da-92e3-0800200c9a66", info.uuid);
	}

	@Test
	public void testGetShortName() {
		assertEquals(
			"IISI Review panel 2000", LangString.getFirst(info.shortName));
	}
	...
	public void testGetContactAddress() {
		assertEquals(
			...
			LangString.getFirst(info.contactAddress));
	}

	@Test
	public void testGetTelephone() {
		assertEquals("+32 2 702 89 00", info.telephone);
	}

	@Test
	public void testGetTelefax() {
		assertEquals("+32 2 702 88 99", info.telefax);
	}

	@Test
	public void testGetWebSite() {
		assertEquals("www.worldsteel.org", info.webSite);
	}
	...
	public void testGetCentralContactPoint() {
		assertEquals(
			"Rue Colonel Bourg 120 B-1140 Brussels, Belgium",
			LangString.getFirst(info.centralContactPoint));
	}
